...
angular.module('MainCtrl', []).controller('MainController', function($scope) {
    ...
    $scope.items = [{name:"Tacos", type:"red", test:3, masonryCardType:"item item--W2"},
		...
		{name:"Tacos", type:"red", test:2, masonryCardType:"item item--W2"},
                ...
                {name:"Tacos", type:"red", test:8, masonryCardType:"item item--box"},
                {name:"Tamales", type:"green", test:2, masonryCardType:"item item--box"},
                {name:"Tamales", type:"red", test:8, masonryCardType:"item item--W2"},
                {name:"Tacos", type:"blue", test:3, masonryCardType:"item item--banner"},
		{name:"Tacos", type:"red", test:2, masonryCardType:"item item--box"},
                {name:"Burrito", type:"blue", test:3, masonryCardType:"item item--box"},
                {name:"Tacos", type:"red", test:8, masonryCardType:"item item--box"},
                {name:"Tamales", type:"green", test:2, masonryCardType:"item item--box"},
                {name:"Tamales", type:"red", test:8, masonryCardType:"item item--box"},
                {name:"Tacos", type:"blue", test:3, masonryCardType:"item item--box"},
		];
